...
import { Eye, EyeOff, GraduationCap, Users, Mail, Lock, ArrowLeft } from 'lucide-react'
...
export default function LoginForm() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        toast({
            ...
            description: `Welcome back! You've been logged in as a ${formData.userType}.`,
        })
                ...
                <CardContent>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4 mt-6">
                        ...
                        <Button 
                            ...
                            disabled={isLoading}
                        >
                            {isLoading ? 'Signing In...' : `Sign In as ${activeTab === 'student' ? 'Student' : 'Teacher'}`}
                        </Button>
                    </form>
